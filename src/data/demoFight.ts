...
export const DEMO_FIGHT: FightEvent[] = [
  ...
  { round: 2, attacker: "opponent", action: "gnp_punch", hit: "clean",
    message: "Ground and pound del campeón desde la guardia." },
  ...
  { round: 2, attacker: "player", action: "gnp_elbow", hit: "clean",
    message: "Lluvia de codos desde arriba. El árbitro se acerca…" },
